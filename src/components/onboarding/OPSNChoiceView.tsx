...
function StructureCard({
  ...
  return (
    ...
    >
      ...
      <h3>{structure.shortname || structure.name}</h3>
  ...
  return (
    <>
      ...
      <p className={fr.cx("fr-text--lg", "fr-mb-3w")}>
        ...
        mutualisation de son choix pour mettre en oeuvre nos outils. Rejoignez son Groupe pilote dès
      ...
      <p className={fr.cx("fr-text--lg", "fr-mt-4w")}>
        ...
        <Link href={`/bienvenue/${commune.siret}/inscription`} className={fr.cx("fr-link")}>
          contactez-nous
        </Link>
        .
      </p>
