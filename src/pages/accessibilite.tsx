    ...
    <>
      ...
      <div className={fr.cx("fr-py-6w", "fr-container")}>
        ...
        <p>
          ...
          <span>
            {" "}
            (<span>https://suiteterritoriale.anct.gouv.fr</span>)
          </span>
          .
        </p>
        <h2>État de conformité</h2>
        <p>
          <strong>La Suite territoriale - site vitrine</strong> est{" "}
          <strong>
            <span data-printfilter="lowercase">non conforme</span>
          </strong>{" "}
          avec le{" "}
          <abbr title="Référentiel général d&rsquo;amélioration de l&rsquo;accessibilité">
            RGAA
          </abbr>
          .{" "}
          <span>
            Le site n&rsquo;a encore pas été audité.
            <br />
          </span>
        </p>
        <p>
        ...
        <p>
          Cette déclaration a été établie le <span>21 mars 2025</span>.
        </p>
        ...
        <p>
          Nous essayons de répondre dans les <span>2 semaines</span>.
        </p>
        ...
        <p>
          ...
          <Link
            ...
            rel="noopener noreferrer"
          >
            Générateur de Déclaration d&rsquo;Accessibilité
          </Link>
          .
        </p>
      </div>
