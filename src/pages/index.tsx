...
export default function Home() {
  ...
  const tools: ToolItem[] = [
    {
      ...
      description: (
        <>
          pour les agents publics et les élus locaux de toutes les collectivités
          territoriales
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          composé d&rsquo;un nom de domaine conforme, d&rsquo;une messagerie et
          d&rsquo;un espace de stockage
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          opérés par l&rsquo;État, les opérateurs de mutualisation et les
          éditeurs privés
        </>
      ),
  ...
  const stats: StatItem[] = [
    {
      ...
      content: (
        <>
          Selon les données de l&rsquo;Etat, 11&nbsp;000 communes ne disposent
          pas d&rsquo;un nom de domaine permettant une identification formelle
          en ligne via un site web ou une adresse de messagerie.
          <br />
          <br />
          Voir notre{" "}
          <Link
    ...
    // },
    {
      ...
      content: (
        <>
          2 900 sites web de communes utilisent une extension inadéquate (.com,
          .org etc). Seuls le <strong>.fr</strong> et les extensions
          géographiques (<strong>.bzh</strong>, <strong>.re</strong>, ...)
          constituent une marque de confiance suffisante.
          <br />
          <br />
          Voir notre{" "}
          <Link
    ...
    },
    {
      ...
      content: (
        <>
          10% des collectivités déclarent avoir été victimes d&rsquo;une ou
          plusieurs cyberattaques au cours des 12 derniers mois. 45% des
          victimes n&rsquo;en identifient pas la cause.
          <br />
          <br />
          Voir la{" "}
          <Link
    ...
    },
    {
      ...
      content: (
        <>
          278 organismes publics (communes, EPCI, syndicats, hôpitaux) victimes
          de cyberattaques ont été recensés par le réseau Déclic depuis 2019
          <br />
          <br />
          Voir la{" "}
          <Link
    ...
    },
    {
      ...
      content: (
        <>
          La moitié des adresses de contact des collectivités ont fait
          l&rsquo;objet d&rsquo;une ou plusieurs fuites de données, dont une
          majorité concerne potentiellement le mot de passe.
          <br />
          <br />
    ...
    },
    {
      ...
      content: (
        <>
          La majorité des emails des collectivités reposent sur des noms de
          domaine génériques rendant l&rsquo;identification formelle du
          destinataire et de l&rsquo;expéditeur impossible : wanadoo.fr,
          orange.fr, gmail.com, yahoo.fr, etc.
          <br />
          <br />
          Voir notre{" "}
          <Link
...

    {
      ...
      content: (
        <>
          Les principales causes de la vulnérabilité des collectivités face aux
          cyberattaques relèvent de l&rsquo;usage et des outils numériques
          utilisés. L&rsquo;hameçonnage (ou <i>phishing</i>) est la cause
          principale (30%) suivi du téléchargement d&rsquo;un virus et de la
          consultation d&rsquo;un site infecté (10%).
          <br />
          <br />
          Voir la{" "}
          <Link
    ...
    },
    {
      ...
      content: (
        <>
          Les CSIRT territoriaux et l&rsquo;ANSSI ont recensé en moyenne 18
          incidents cyber affectant une collectivité territoriale tous les mois.
          Ces incidents représentent 14% de l&rsquo;ensemble des incidents
          traités par l&rsquo;ANSSI.
          <br />
          <br />
          Voir la{" "}
          <Link
            ...
            rel="noopener"
          >
            synthèse de l&rsquo;ANSSI sur la menace ciblant les collectivités
  ...
  return (
    <>
      {/* Hero section with lighter blue background */}
      <section
        style={{
          position: "relative",
        ...
        >
          <div className={fr.cx("fr-grid-row", "fr-grid-row--center")}>
            ...
            >
              ...
              <p
                className={fr.cx("fr-text--lg", "fr-mb-3w")}
                style={{ textAlign: "center" }}
              >
                Un ensemble de services numériques simples, souverains et
                sécurisés pour&nbsp;outiller les&nbsp;collectivités
                territoriales dans leurs besoins essentiels.
              </p>
          ...
          {/* Search component */}
          <div
            className={fr.cx("fr-grid-row", "fr-grid-row--center", "fr-mb-2w")}
          >
      ...
      */}
      ...
      >
        <div className={fr.cx("fr-container", "fr-py-2w")}>
          <span className={fr.cx("fr-icon-info-fill")}></span>
          <span>
            <strong>&nbsp;Webinaires et permanences &nbsp;</strong> Notre équipe
            répond à toutes vos questions et vous présente l&rsquo;actualité de
            la Suite territoriale. &nbsp;&nbsp;
            <Link
              href="https://grist.incubateur.anct.gouv.fr/o/anct/forms/wGtUJsgNfkD3wRNUHULm5B/500"
              className={fr.cx("fr-link")}
      ...
      <section style={{ backgroundColor: "var(--background-alt-blue-france)" }}>
        <div className={fr.cx("fr-container", "fr-pt-8w")}>
          <h2 className={fr.cx("fr-h2", "fr-mb-6w")}>
      ...
      <section style={{ backgroundColor: "var(--background-alt-blue-france)" }}>
        <div className={fr.cx("fr-container", "fr-py-6w")}>
          <div
            className={fr.cx("fr-grid-row", "fr-px-4w")}
          ...
          >
            ...
            >
              ...
              <p>
                Elle permet d&rsquo;identifier les communes françaises dotées ou
                non du socle de services numériques essentiels garantissant une
                communication en ligne sécurisée selon quatre critères, tout en
                facilitant l&rsquo;actualisation de leurs données.
              </p>
              <Button
                priority="secondary"
                iconPosition="right"
